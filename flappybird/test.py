...
# Code from Lecture 2, 11/09/2018
# mdtaylor


## This code demonstrates simple OOPy animation!
# This code was made *extremely quickly* and is very basic...
# ...So if you want some OOPy animation practice, add some features!
#       1. Add a score count
...
def init(data):
    data.timerDelay = 50 # Tweak this to change game speed
